...
import 'package:aarogya/Login.dart';
                        ...
                        if (userCredential.user != null) {
                          ...
                          timer = Timer.periodic(Duration(seconds: 3), (timer) async{
                            ...
                            if (auth.currentUser!.emailVerified){
                              ...
                              firestore.doc('VerifiedPatients').collection("Patients").add({auth.currentUser!.uid : auth.currentUser!.email.toString()});
                              firestore.doc("Patients").collection("PatientUids").doc(auth.currentUser!.uid).set(
                                  {
                                    "name": nameCtrl.text,
