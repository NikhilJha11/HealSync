  ...
  static Future<List<String>> getModels() async {
    try {
      var response = await http.get(
        ...
        headers: {'Authorization': 'Bearer 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'},
      );
  ...
  static Future<String> sendMessage(
    ...
    try {
      var response = await http.post(
        ...
        headers: {
          'Authorization': 'Bearer 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',
